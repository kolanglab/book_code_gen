...
[Lattner and Adve, 2004](#cite:lattner2004)。
...
[Aho and Johnson, 1976](#cite:aho1976)。
...
を持つ形式です [Aho et al., 2006](#cite:aho2006)。各命令はちょうど1つの基本的な
演算だけを行います。
...
[Sasada, 2005](#cite:sasada2005)がこの方式を採っています。
...
[Cytron et al., 1991](#cite:cytron1991)が確立し、いまでは LLVM をはじめ多くの
